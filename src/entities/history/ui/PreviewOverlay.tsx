...
export function PreviewOverlay() {
	...
	return (
		<div className="absolute top-4 left-1/2 -translate-x-1/2 bg-amber-100 border border-amber-300 text-amber-800 px-4 py-2 rounded shadow-md z-50 flex items-center gap-4">
